...
INSERT INTO "new_Users" ("birthDate", "createdAt", "deletedAt", "document", "email", "isActivated", "parentUuid", "password", "preRegisterDate", "registerDate", "tokePreRegister", "tokenDiscount", "updatedAt", "uuid", "walletUuid") SELECT "birthDate", "createdAt", "deletedAt", "document", "email", "isActivated", "parentUuid", "password", "preRegisterDate", "registerDate", "tokePreRegister", "tokenDiscount", "updatedAt", "uuid", "walletUuid" FROM "Users";
DROP TABLE "Users";
